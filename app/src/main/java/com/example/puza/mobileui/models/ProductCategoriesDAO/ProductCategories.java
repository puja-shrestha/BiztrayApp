...
package com.example.puza.mobileui.models.ProductCategoriesDAO;
...
public class ProductCategories implements Serializable, Parcelable
{
    ...
    protected ProductCategories(Parcel in) {
        ...
        in.readList(this.message, (com.example.puza.mobileui.models.ProductCategoriesDAO.Message.class.getClassLoader()));
    }
